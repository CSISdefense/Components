...
RawRegime<-subset(RawRegime,ServicesCategory.sum=="Services (Non-R&D)")
...
PSRUSDATL<-subset(RawRegime,join(RawRegime,ATLregimeFYear)$AnnualRegimeObligations>=50)
...
PSRUSDATL$SinceFirstFiscalYear<-as.numeric(as.duration(
    ymd(PSRUSDATL$SignedMonth)-PSRUSDATL$StartFiscalYear)
    /dyears(1)
    )
...
write.csv(USDATLTable,paste("Output\\PSR_services\\",
                                  paste("DoD_components"
                                        ,"Obligation_2014"
                                        ,"PSR_services"
                                        ,"USDATL"
...
write.csv(PolicyTable,paste("Output\\PSR_services\\",
                                  paste("DoD_components"
                                        ,"Obligation_2014"
                                        ,"PSR_services"
                                        ,"ATLpolicy"
