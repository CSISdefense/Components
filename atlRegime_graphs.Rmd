...
```{r DataTables}
FixedRegimeTable<-ddply(FixedRegime, c("Fiscal.Year"
    ,"Pricing.Mechanism.sum"
    ,"SubCustomer.component"
    ,"USDATL")
    ,summarise
...
write.csv(FixedRegimeTable,paste(paste("DoD_components"
                 ,"Obligation_2014"
                 ,"Pricing_Mechanism_sum"
                 ,"USDATL"
                 ,"Annual"
...
FixedPolicyTable<-ddply(FixedPolicy, c("Fiscal.Year"
    ,"Pricing.Mechanism.sum"
    ,"SubCustomer.component"
    ,"ATLpolicy")
    ,summarise
...
write.csv(FixedPolicyTable,paste(paste("DoD_components"
                 ,"Obligation_2014"
                 ,"Pricing_Mechanism_sum"
                 ,"ATLpolicy"
                 ,"Annual"
