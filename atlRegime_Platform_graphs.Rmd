...
PlatformGraph<-LatticePercentLineWrapper(
    VAR.color.legend.label="Platform Portfolio"
    ,""#VAR.main.label=""#Overall DoD Platform Portfolio by Starting Regime"
...
for (c in unique(Policy$SubCustomer)){    
    ...
    PlatformGraph<-LatticePercentLineWrapper(
        VAR.color.legend.label="Platform Portfolio"
        ,VAR.main.label=""#paste(c,"Platform Portfolio by Starting Regime")
        ,VAR.X.label="Month of Obligation (6 Month Lagging Average)"
...
for (s in unique(Policy$ PlatformPortfolio.AnD)){    
    png(
        paste( "Output\\Platform\\",
               CleanFileName(paste(
                   "DoD"
    ...
    Policy$Graph[Policy$ PlatformPortfolio.AnD!=s]<-FALSE
    Policy$Graph[Policy$ PlatformPortfolio.AnD==s]<-TRUE
...
OldGraph<-Policy$Graph
for (c in unique(Policy$SubCustomer)){ 
    PlatformSubCustomer<-subset(Policy,SubCustomer==c)
    for (s in unique(Policy$ PlatformPortfolio.AnD)){    
...
write.csv(USDATLTable,paste("Output\\Platform\\",
                                  paste("DoD_components"
                                        ,"Obligation_2014"
                                        ,"Platform_sum"
                                        ,"USDATL"
...
write.csv(PolicyTable,paste("Output\\Platform\\",
                                  paste("DoD_components"
                                        ,"Obligation_2014"
                                        ,"Platform_sum"
                                        ,"ATLpolicy"
