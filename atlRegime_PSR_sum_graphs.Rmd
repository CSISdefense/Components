...
PSRGraph<-LatticePercentLineWrapper(
    VAR.color.legend.label="Product/Service/R&D"
    ,""#VAR.main.label=""#Overall DoD Product/Service/R&D by Starting Regime"
...
for (c in unique(Policy$SubCustomer)){    
    ...
    PSRGraph<-LatticePercentLineWrapper(
        VAR.color.legend.label="Product/Service/R&D"
        ,VAR.main.label=""#paste(c,"Product/Service/R&D by Starting Regime")
        ,VAR.X.label="Month of Obligation (6 Month Lagging Average)"
...
for (s in unique(Policy$ ServicesCategory.sum)){    
    png(
        paste( "Output\\PSR_sum\\",
               CleanFileName(paste(
                   "DoD"
    ...
    Policy$Graph[Policy$ ServicesCategory.sum!=s]<-FALSE
    Policy$Graph[Policy$ ServicesCategory.sum==s]<-TRUE
...
write.csv(USDATLTable,paste("Output\\PSR_sum\\",
                                  paste("DoD_components"
                                        ,"Obligation_2014"
                                        ,"PSR_sum"
                                        ,"USDATL"
...
write.csv(PolicyTable,paste("Output\\PSR_sum\\",
                                  paste("DoD_components"
                                        ,"Obligation_2014"
                                        ,"PSR_sum"
                                        ,"ATLpolicy"
