...
for (c in unique(VendorPolicy$SubCustomer)){    
    png(
        paste( "Output\\Vendor_Size\\",c,"\\",CleanFileName(paste(
            c
            ,"Obligation_2014"
            ,"Vendor_Size_sum"
            ,"ATLpolicy"
...
```{r VendorPolicySeriesHorseTailSummary}
...
```{r VendorPolicySeriesHorseTailComponents}
...
```{r VendorPolicySeriesSpendingBarSummary}
...
```{r VendorPolicySeriesHorseTailComponentSolitary}
...
```{r VendorPolicySeriesSpendingBarComponentSolitary}
